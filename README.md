...
**[Find PI to the Nth Digit](Python/Find%20PI%20to%20the%20Nth%20Digit)** - Enter a number and have the program generate PI up to that many decimal places. Keep a limit to how far the program will go. ([JavaScript](JavaScript/Find%20PI%20to%20the%20Nth%20Digit))

**[Fibonacci Sequence](Python/Fibonacci%20Sequence)** - Enter a number and have the program generate the Fibonacci sequence to that number or to the Nth number. ([JavaScript](JavaScript/Fibonacci%20Sequence))

**[Prime Factorization](Python/Prime%20Factorization)** - Have the user enter a number and find all Prime Factors (if there are any) and display them. ([JavaScript](JavaScript/Prime%20Factorization))

**[Next Prime Number](Python/Next%20Prime%20Number)** - Have the program find prime numbers until the user chooses to stop asking for the next one.

**[Find Cost of Tile to Cover W x H Floor](JavaScript/Find%20Cost%20of%20Tile)** - Calculate the total cost of tile it would take to cover a floor plan of width and height, using a cost entered by the user.

**[Mortgage Calculator](JavaScript/Mortgage%20Calculator)** - Calculate the monthly payments of a fixed term mortgage over given Nth terms at a given interest rate. Also figure out how long it will take the user to pay back the loan.

**Change Return Program** - The user enters a cost and then the amount of money given. The program will figure out the change and the number of quarters, dimes, nickels, pennies needed for the change.

**[Binary to Decimal and Back Converter](JavaScript/Binary%20and%20Decimal)** - Develop a converter to convert a decimal number to binary or a binary number to its decimal equivalent.

**[Calculator](JavaScript/Calculator)** - A simple calculator to do basic operators. Make it a scientific calculator for added complexity.
...
**[Credit Card Validator](Python/Credit%20Card%20Validator)** - Takes in a credit card number from a common credit card vendor (Visa, MasterCard, American Express, Discoverer) and validates it to make sure that it is a valid number (look into how credit cards use a checksum).
...
**[Sorting](JavaScript/Sorting)** - Implement two types of sorting algorithms: Merge sort and bubble sort.
...
**Text : Reverse a String** - Enter a string and the program will reverse it and print it out.
